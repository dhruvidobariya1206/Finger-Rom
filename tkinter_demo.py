...
#             try:
#                 query = "Select * from patients where PName='"+username+"' and Password='"+password+"'"
...
#                     query = "insert into patients(PName, PPhone, PBlood, Password) values('"+user+"','"+phone+"','"+bloodGrp+"','"+pw+"')"
#                     print(query)
#                     db_conn.mycursor.execute(query)

...
#         frame1 = tk.LabelFrame(self, tkdemo.frame_styles, text="This is a LabelFrame containing a Treeview")
#         frame1.place(rely=0.05, relx=0.02, height=400, width=400)

#         frame2 = tk.LabelFrame(self, tkdemo.frame_styles, text="Some widgets")
...
#         def Load_data():
#             for row in tkdemo.pokemon_info:
